...
export default defineSchema({
  portfolio: defineTable({
    ...
    creativeHead: v.optional(v.string()),
    agencyHead: v.optional(v.string()),
    servicing: v.optional(v.string()),
    ...
    productionManager: v.optional(v.string()),
    associateDirector: v.optional(v.string()),
    assistantDirectors: v.optional(v.string()),
    modelCoordinators: v.optional(v.string()),
    ...
    di: v.optional(v.string()),
    cg: v.optional(v.string()),
